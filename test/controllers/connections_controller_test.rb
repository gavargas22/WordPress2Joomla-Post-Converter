...
class ConnectionsControllerTest < ActionController::TestCase
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post :create, connection: { db_host: @connection.db_host, db_name: @connection.db_name, db_password: @connection.db_password, db_username: @connection.db_username }
    end
  ...
  test "should update connection" do
    patch :update, id: @connection, connection: { db_host: @connection.db_host, db_name: @connection.db_name, db_password: @connection.db_password, db_username: @connection.db_username }
    assert_redirected_to connection_path(assigns(:connection))
  end
